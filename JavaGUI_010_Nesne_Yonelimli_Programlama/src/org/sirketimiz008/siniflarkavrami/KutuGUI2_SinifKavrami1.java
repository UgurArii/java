 ...
 * @author uğur
 */
public class KutuGUI2_SinifKavrami1 extends javax.swing.JFrame {

	/**
	 * Creates new form KutuGUI1_SinifKavrami
	 */
	public KutuGUI2_SinifKavrami1() {
		initComponents();
	}
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(KutuGUI2_SinifKavrami1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				new KutuGUI2_SinifKavrami1().setVisible(true);
			}
		});
	}
